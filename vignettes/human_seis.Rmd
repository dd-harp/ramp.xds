...
seis = xds_setup(Xname = "SEIS", MYZname = "trace", MYZopts = MYZo, Xopts=Xo, HPop=HPop)
seis = xde_solve(seis, 3650, 15)
```
...
```{r}
SEISd = xds_setup(Xname = "SEISd", MYZname = "trace", MYZopts = MYZo, Xopts=Xo, HPop=HPop)
SEISd$dlay = "dde" 
class(SEISd$dlay) = "dde" 
SEISd = xde_solve(SEISd, Tmax = 3650, dt=15)
```
