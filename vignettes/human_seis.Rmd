...
**`ramp.xds`** includes the standard SEIS model and the delay SEIS model. Note that the time step is per day.  The dependent state variables for both models are:
