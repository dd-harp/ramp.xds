...
Models for adult mosquito ecology, behavior, and infection dynamics in **`ramp.xds`** are all variants of basic models for mosquito infection dynamics. [**`ramp.library`**](https://dd-harp.github.io/ramp.library/) includes an expanded set of  models for adult mosquitoes, including some behavioral state models (see [MYZ-Overview](https://dd-harp.github.io/ramp.library/articles/MYZ-Overview.html)). 
The dynamical terms rquired by $\cal MYZ$ models are: 
...
+ **`basicM`** - no infection dynamics (see [dMYZdt.basicM](https://dd-harp.github.io/ramp.xds/reference/dMYZdt.basicM.html)) 
...
+ **`si`** - A standard SI compartmental model for infection, see [dMYZdt.si](https://dd-harp.github.io/ramp.xds/reference/dMYZdt.si.html). 
