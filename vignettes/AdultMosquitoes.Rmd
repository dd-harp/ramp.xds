...
The basic mosquito models in **`ramp.xds`** are variants of George Macdonald mathematical models, developed with help from P. Armitage. 
...
+ $\mu$ - a vector describing migration-related loss 
