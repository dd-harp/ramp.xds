...
***
![**Figure 1** - A diagram of the **L** Component in context](images/L_component.png){width=100%}
...
[aquatic-L.R](https://github.com/dd-harp/ramp.xds/blob/main/R/aquatic-L.R){target="_blank"}, and 3 that work generically. Each module defines two additional functions to set up an **L** object and the initial values.
