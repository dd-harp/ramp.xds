...
The module for adult mosquito ecology and infection dynamics is called `MYname.` The default module is Macdonald's model: 
...
To set up a seasonality function, we pass a parameter set from `makepar_F_sin` as `season_par`.
...
A good next step is the [Basic Setup](https://dd-harp.github.io/ramp.xds/articles/BasicSetup.html) vignette.