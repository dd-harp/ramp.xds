...
It is easy to change the `trace` function. A trace function library for `ramp.xds` is found in [`ramp.trace`](https://github.com/dd-harp/ramp.trace). For more information about configuring trace functions for `ramp.xds`
