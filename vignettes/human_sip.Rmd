...
params = make_parameters_X_SIP_xde(pars = params, b = b, c = c, r = r, rho = rho, eta = eta, xi=xi)
params = make_inits_X_SIP_xde(pars = params, H-I-P, I, as.vector(P))
...
```{r}
xde_setup_cohort(F_eir, Xname="SIP_xde", HPop=Hpop, Xopts = Xo) -> test_SIP_xde
```
