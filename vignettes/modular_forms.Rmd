...
![**Figure 1** - Diagram of a Ross-Macdonald model in Box 1, rewritten in a modular form.](images/RossMacdonaldFormal.png){width=100%}
...
![**Figure 2** - Diagram of a Ross-Macdonald model that shows how the dynamical terms are computed, step-by-step, to enable models with spatial dynamics and realism.](images/RossMacdonaldFormal2.png){width=100%}
