...
vignette: >
  %\VignetteIndexEntry{RAMP and SimBA}
...
![A diagram of the R packages and their dependencies. Clicking on the package icon takes you to its `github.io` page. SimBA is also a website (grey) with material to support model building.](ramp_packages.html){width=624px height=380px}
