...
params = make_parameters_L_basicL_xde(params, psi = psi, phi = phi, theta = theta)
params = make_inits_L_basicL_xde(params, L0=L0)
```
...
params = make_parameters_MYZ_RM_xde(pars = params, g = g, 
                sigma=sigma, mu=mu, calK=calK, eip=eip, 
                 f=f, q=q, nu=nu, 
...
params = make_inits_X_SIS_xde(params, S0 = H-I0, I0=I0)
```
...
```{r}
xde_setup("mod534", "RM_xde", "SIS_xde", "basicL_xde", 
                  nPatches = 3, HPop=c(10, 90, 100, 900), membership=c(1,1,1,2,2), 
                  MYZopts=MYZo, calK=calK, Xopts=Xo, EIPopts = EIPo,
