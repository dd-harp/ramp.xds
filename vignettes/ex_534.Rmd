...
```{r}
params = make_xds_object_template("dde", "full", nPatches, membership, residence) 
```
...
This was created by `make_xds_object_template` and stored as `params$habitat_matrix` 
