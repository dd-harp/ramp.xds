...
nHabitats=1
membership=1
params <- make_xds_object_template("ode", "cohort", nPatches, membership, residence)
```
...
arams <- setup_XH_inits(params, H, 1, Xo)
```
...
```{r}
xds_setup_cohort(eir, Xname="SIS", HPop=H, XHoptions = Xo) -> test_SIS_xde
```
