...
clrs = turbo(5)
with(out1,{
  plot(age, XH[[1]]$true_pr[,1], col = clrs[1], ylim = c(0,1), type = "l")
  lines(age, XH[[1]]$true_pr[,2], col = clrs[2])
  lines(age, XH[[1]]$true_pr[,3], col =clrs[5])
...
```{r}
xde_solve_cohort(eir, 0, test_SIS_xde)$outputs$cohort -> out2
