...
params = make_parameters_MYZ_basicM_xde(pars = params, g = g, sigma = sigma, mu=mu, calK = calK, f = f, q = q, nu = nu, eggsPerBatch = eggsPerBatch)
params = make_inits_MYZ_basicM_xde(params, M0=M_eq, P0=P_eq)
...
```{r}
xde_setup_mosy(MYZname = "basicM_xde", Lname = "trace", 
