...
```{r}
xde_setup(MYZname="RM_xde", Xname="SIS_xde", Lname="basicL_xde", 
          nPatches=3, HPop=Hpop, membership=c(1:3), MYZopts=MYZo, calK=calK, 
...
out <- out[, -c(itn_mod$ix$MYZ[[1]]$Upsilon_ix+1)]
