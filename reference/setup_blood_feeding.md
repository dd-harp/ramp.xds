...
sets up the blood feeding interface, `xds_obj$blood_feeding`

## Usage

``` r
setup_blood_feeding(xds_obj, residence)
```
...
`blood_feeding`, attached to the **`xds`** model object as
`xds_obj$blood_feeding.`
