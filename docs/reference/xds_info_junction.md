...
In **`ramp.xds,`** clusters of ports are sometimes bundled into a
**junction** (see
[xds_info_port](https://dd-harp.github.io/ramp.xds/reference/xds_info_port.md)).
A junction is a structural element, a function that is designed to
handle one or more ports.

- [Other_State_Variables](https://dd-harp.github.io/ramp.xds/reference/Other_State_Variables.md)
  – a junction to add new state variables, effectively extending the
  dynamical system

- [xds_info_forcing](https://dd-harp.github.io/ramp.xds/reference/xds_info_forcing.md)
  – a junction to handle exogenous forcing by weather, *etc.*
