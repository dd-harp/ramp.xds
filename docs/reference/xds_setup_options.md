...
Parameter values and initial values for the variables are passed as
named lists. The module help pages have information about how to
configure: `Xoptions,` `MYoptions,` & `Loptions.`
