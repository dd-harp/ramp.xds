This folder contains an R package. It implements a mathematical framework for building systems of differential equations that describe mosquito-borne pathogen dynamics.
...
### Vignettes
- More latitude — auto-fix minor grammar, punctuation, double words, and awkward phrasing.
- Provide a before/after change list to review after edits are applied.

### Both
- Do not touch technical terms (function names, parameter names, mathematical notation, etc.).
