...
#' @title Get parameters for `SIS` (**XH**)
#'
#' @description
...
#'
#' @description Get the value of variables
...
#' @title Setup initial values for `SIS` (**XH**)
#'
...
#' @title Change initial values for `SIS` (**XH**)
#'
#' @description
#'
