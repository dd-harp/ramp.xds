...
setup_vector_control_object = function(xds_obj){
  ...
  xds_obj$control_obj$vector_control_obj <- vector_control
  return(xds_obj)
}
...
VectorControl = function(t, y, xds_obj){
  UseMethod("VectorControl", xds_obj$control_obj$vector_control_obj)
}
...
VectorControlEffectSizes <- function(t, y, xds_obj) {
  UseMethod("VectorControlEffectSizes", xds_obj$control_obj$vector_control_obj)
}
