...
#' @description Implements [dXdt] for the SIS xde model, no demography.
#' @inheritParams dXdt
...
#' @return a [list]
#' @export
make_Xpar_SIS_xde = function(nStrata, Xopts=list(),
...
#' @title Setup Xpar.SIS_xde
#' @description Implements [xde_setup_Xpar] for the SIS_xde model
#' @inheritParams xde_setup_Xpar
#' @return a [list] vector
#' @export
xde_setup_Xpar.SIS_xde = function(Xname, pars, i, Xopts=list()){
  pars$Xpar[[i]] = make_Xpar_SIS_xde(pars$Hpar[[i]]$nStrata, Xopts)
  return(pars)
}

# specialized methods for the human SIS_xde model

#' @title Size of effective infectious human population
#' @description Implements [F_X] for the SIS_xde model.
#' @inheritParams F_X
#' @return a [numeric] vector of length `nStrata`
#' @export
F_X.SIS_xde <- function(t, y, pars, i) {
...
#' @title Size of effective infectious human population
#' @description Implements [F_H] for the SIS_xde model.
#' @inheritParams F_H
#' @return a [numeric] vector of length `nStrata`
#' @export
F_H.SIS_xde <- function(t, y, pars, i){
  with(list_Xvars(y, pars, i), return(S+I))
}


#' @title Infection blocking pre-erythrocytic immunity
#' @description Implements [F_b] for the SIS_xde model.
#' @inheritParams F_b
#' @return a [numeric] vector of length `nStrata`
#' @export
F_b.SIS_xde <- function(y, pars, i) {
  with(pars$Xpar[[i]], b)
}
...
#' @return a [list]
#' @export
make_Xinits_SIS_xde = function(nStrata, Xopts = list(), H0=NULL, S0=NULL, I0=1){with(Xopts,{
...
#' @return a [list]
#' @export
list_Xvars.SIS_xde <- function(y, pars, i) {
  with(pars$ix$X[[i]],
      return(list(
        S = y[S_ix],
        I = y[I_ix]
...
#' @title Setup Xinits.SIS_xde
#' @description Implements [setup_Xinits] for the SIS_xde model
#' @inheritParams setup_Xinits
#' @return a [list] vector
#' @export
setup_Xinits.SIS_xde = function(pars, i, Xopts=list()){
  pars$Xinits[[i]] = with(pars,make_Xinits_SIS_xde(pars$Hpar[[i]]$nStrata, Xopts, H0=Hpar[[i]]$H))
  return(pars)
}

#' @title Add indices for human population to parameter list
#' @description Implements [make_indices_X] for the SIS_xde model.
#' @inheritParams make_indices_X
#' @return none
#' @importFrom utils tail
#' @export
make_indices_X.SIS_xde <- function(pars, i) {with(pars,{
...
#' @return a [numeric] vector
#' @export
get_inits_X.SIS_xde <- function(pars, i){
...
#' @return none
#' @export
update_inits_X.SIS_xde <- function(pars, y0, i) {
  with(list_Xvars(y0, pars, i),{
    pars$Xinits[[i]] = make_Xinits_SIS_xde(pars, list(), S0=S, I0=I)
    return(pars)
})}
...
#' @title Compute the HTC for the SIS_xde model
#' @description Implements [HTC] for the SIS_xde model with demography.
#' @inheritParams HTC
#' @return a [numeric] vector
#' @export
HTC.SIS_xde <- function(pars, i) {
  with(pars$Xpar[[i]],
    return(c/r)
  )
}
...
#' @description Implements [F_pr] for the SIS_xde model.
#' @inheritParams F_pr
#' @return a [numeric] vector of length `nStrata`
#' @export
F_pr.SIS_xde <- function(varslist, pars, i) {
...
#' @return a [list]
#' @export
make_parameters_X_SIS_xde <- function(pars, b, c, r) {
  stopifnot(is.numeric(b), is.numeric(c), is.numeric(r))
  Xpar <- list()
  class(Xpar) <- c('SIS_xde', 'SISdX')
  Xpar$b <- b
  Xpar$c <- c
  Xpar$r <- r
  pars$Xpar[[1]] <- Xpar
...
#' @return none
#' @export
make_inits_X_SIS_xde <- function(pars, S0, I0) {
  stopifnot(is.numeric(S0))
