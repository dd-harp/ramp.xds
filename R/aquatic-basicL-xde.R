# specialized methods for the aquatic mosquito basicL_xde competition model
...
#' @return a named [list]
#' @export
LBionomics.basicL_xde <- function(t, y, pars, s) {with(pars$Lpar[[s]],{
...
#' @description Implements [F_alpha] for the basicL_xde competition model.
#' @inheritParams F_alpha
#' @return a [numeric] vector of length `nHabitats`
#' @export
F_alpha.basicL_xde <- function(t, y, pars, s) {
...
#' @description Implements [dLdt] for the basicL_xde competition model.
#' @inheritParams dLdt
#' @return a [numeric] vector
#' @export
dLdt.basicL_xde <- function(t, y, pars, s) {
...
#' @title Setup the basicL_xde model
#' @description Implements [setup_Linits] for the basicL_xde model
#' @inheritParams setup_Linits
#' @return a [list]
#' @export
setup_Linits.basicL_xde = function(pars, s, Lopts=list()){
  pars$Linits[[s]] = make_Linits_basicL_xde(pars$nHabitats, Lopts)
  return(pars)
}

#' @title Make parameters for basicL_xde competition aquatic mosquito model
...
#' @export
make_Lpar_basicL_xde = function(nHabitats, Lopts=list(), psi=1/8, phi=1/8, theta=1/100){with(Lopts,{
  Lpar = list()
  class(Lpar) <- "basicL_xde"
...
#' @title Make inits for basicL_xde competition aquatic mosquito model
#' @param nHabitats the number of habitats in the model
#' @param Lopts a [list] that overwrites default values
#' @param L0 initial conditions
#' @return a [list] with Linits added
#' @export
make_Linits_basicL_xde = function(nHabitats, Lopts=list(), L0=1){with(Lopts,{
  L0 = checkIt(L0, nHabitats)
  return(list(L=L0))
})}

#' @title Add indices for aquatic stage mosquitoes to parameter list
#' @description Implements [make_indices_L] for basicL_xde competition model.
#' @inheritParams make_indices_L
#' @return none
#' @importFrom utils tail
#' @export
make_indices_L.basicL_xde <- function(pars, s) {with(pars,{
...
#' @return a [list] with Lpar added
#' @export
make_parameters_L_basicL_xde <- function(pars, psi, phi, theta) {
...
#' @return a [list] with Linits added
#' @export
make_inits_L_basicL_xde <- function(pars, L0){
  stopifnot(is.numeric(L0))
  pars$Linits[[1]] <- list(L=L0)
  return(pars)
}

#' @title Update inits for the basicL_xde aquatic mosquito competition model
#' @inheritParams update_inits_L
#' @return none
#' @export
update_inits_L.basicL_xde <- function(pars, y0, s) {
  L = y0[pars$ix$L[[s]]$L_ix]
  pars = make_Linits_basicL_xde(pars$nHabitats, L0=L)
  return(pars)
}
...
#' @return none
#' @export
get_inits_L.basicL_xde <- function(pars, s){
  pars$Linits[[s]]$L
}
