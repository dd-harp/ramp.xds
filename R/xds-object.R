...
#' @title Make an **`xds`** template
#' @description Creates and returns structured template for an **`xds`** object: all
#' the elements of an **`xds`** object are configured with generic features and default
#' values.
...
#' @seealso Related: [xds_setup()]. Demonstrated in the vignette: [5-3-4 Example](https://dd-harp.github.io/ramp.xds/articles/ex_534.html)
#'
#' @export
